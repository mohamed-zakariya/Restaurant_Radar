...
public class RestaurantView {
    ...
    public void showData() throws SQLException, ClassNotFoundException, IOException {
        ...
        imageView.setImage(new Image("E:\\6 term\\OOP\\project_zmrs_3\\ZMRS_System\\src\\main\\resources\\com\\example\\zmrs_project\\Restaurants\\"+restaurant.getRestaurantName()+".jpg"));
